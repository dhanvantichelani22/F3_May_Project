const api_key = " 3pcDwzA2KlktBWu8jD3FnKxSwSdhrkbdN9m7hx6e ";
...
async function getcurrentImageoftheDay(date) {
  const api_url = `https://api.nasa.gov/planetary/apod?api_key=3pcDwzA2KlktBWu8jD3FnKxSwSdhrkbdN9m7hx6e&date=${date}`;
